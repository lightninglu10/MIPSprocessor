...
void disassemble(inst_t inst)
{
  ...
  case 0x4: // opcode == 0x4 (beq)
      printf("beq\t$%d,$%d,%d\n", inst.itype.rs, inst.itype.rt, (int32_t)((int16_t)(inst.itype.imm)) * 4);
      break;
  ...
  case 0xd: // opcode == 0xd (ORI)
    printf("ori\t$%d,$%d,0x%x\n", inst.itype.rt, inst.itype.rs, (int32_t)((int16_t)(inst.itype.imm)));
    break;
  ...
  case 0x20: // opcode == 0x20 (lb)
      printf("lb\t$%d,%d($%d)\n", inst.itype.rt, (int32_t)((int16_t)inst.itype.imm), inst.itype.rs);
    break;
